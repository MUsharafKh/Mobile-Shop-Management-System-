...
public class Sales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtammount = new java.awt.TextField();
        txtquantity = new java.awt.TextField();
        txtpid = new java.awt.TextField();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        txtcid = new java.awt.TextField();
        ...
        lblimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/shop_pages/Images/experimental-sale-arcade.png"))); // NOI18N
        ...
        temployee.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CUSTOMER ID", "PRODUCT ID", "AMMOUNT", "QUANTITY", "DATE"
            }
        ) {
        ...
        kGradientPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtammount, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtpid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtammount, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
       ...
       else if(txtpid.getText().isEmpty()){
        
            JOptionPane.showMessageDialog(null, "Enter the Product Id");
            return;
        
        }
       else if(txtammount.getText().isEmpty()){
        
            JOptionPane.showMessageDialog(null, "Enter the Ammount");
            return;
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 String queary="insert into mobilesales(id,cid,pid,ammount,quatity) values('"+id+"','"+cid+"','"+pid+"','"+ammount+"','"+qty+"')";
    ...
    try{
        ...
        Connection con=DbConnection.dbconnection();
        Statement st=con.createStatement();
        String quary="select * from mobilesales;";
        ResultSet rs=st.executeQuery(quary);
        DefaultTableModel model=(DefaultTableModel) temployee.getModel();
        model.setRowCount(0);
        String cid,id,pid,amm,qty,date;
        ...
        String[] row={id,cid,pid,amm,qty,date};
        model.addRow(row);
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="DELETE FROM mobilesales WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="UPDATE perches SET cid='"+cid+"',pid='"+pid+"',ammount='"+ammount+"',quatity='"+qty+"'  WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
                    JOptionPane.showMessageDialog(null, "succesfully added !!");
    ...
    private java.awt.TextField txtammount;
    private java.awt.TextField txtcid;
    private java.awt.TextField txtid;
    private java.awt.TextField txtpid;
