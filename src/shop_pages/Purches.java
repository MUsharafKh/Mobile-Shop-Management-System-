...
public class Purches extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtsid = new java.awt.TextField();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        txtproductid = new java.awt.TextField();
        ...
        lblimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/shop_pages/Images/return-purchase.png"))); // NOI18N
        kGradientPanel2.add(lblimage, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, -1, 113));

        jLabel2.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("PURCHES");
        ...
        kGradientPanel2.add(btnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 130, -1));
        ...
        kGradientPanel2.add(btndelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 130, -1));
        ...
        kGradientPanel2.add(btnadd, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 131, -1));
        ...
        temployee.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "PRODUCT ID", "SUPLIER ID", "QUANTITY", "PRICE", "DATE"
            }
        ) {
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtsid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtquantity, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void update(){
      ...
      try{
        ...
        String quary="select * from perches;";
        java.sql.ResultSet rs=st.executeQuery(quary);
        DefaultTableModel model=(DefaultTableModel) temployee.getModel();
        model.setRowCount(0);
        String id,pid,sid,qty,price,date;
        ...
        String[] row={id,pid,sid,qty,price,date};
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
       ...
       else if(txtproductid.getText().isEmpty()){
        ...
        else
        {
           ...
           int ammount=Integer.parseInt(txtprice.getText());
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="insert into perches(id,sid,pid,qantity,price) values('"+id+"','"+sid+"','"+pid+"','"+qty+"','"+ammount+"')";
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="DELETE FROM perches WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="UPDATE perches SET sid='"+sid+"',pid='"+pid+"',ammount='"+ammount+"',qantity='"+qty+"'  WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
                    JOptionPane.showMessageDialog(null, "succesfully added !!");
    ...
    private java.awt.TextField txtproductid;
    private java.awt.TextField txtquantity;
    private java.awt.TextField txtsid;
