...
public class Customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/shop_pages/Images/gender-neutral-user.png"))); // NOI18N
        kGradientPanel2.add(lblimage, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, -1, 113));

        jLabel2.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("CUSTOMER");
        kGradientPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 540, -1, -1));
        ...
        kGradientPanel2.add(btnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, 130, -1));
        ...
        kGradientPanel2.add(btndelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 130, -1));
        ...
        kGradientPanel2.add(btnadd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 131, -1));
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 String queary="insert into customer values('"+id+"','"+name+"','"+address+"','"+contact+"')";
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="DELETE FROM customer WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        else
        {
           ...
           Connection con=DbConnection.dbconnection();
                 ...
                 Statement st=con.createStatement();
                 String queary="UPDATE customer SET name = '"+name+"',address='"+address+"',contact='"+contact+"'   WHERE id='"+id+"';";
                  int result=st.executeUpdate(queary);
                  if(result>0){
                    JOptionPane.showMessageDialog(null, "succesfully added !!");
